...
if authentication_status:
    ...
    print(cat)
    Uniq = xxx.merge(amount_by_month_pre, on='Period', how='left')
    ...
    amount_by_month_bills_5_adj['Item'] = ['Council Tax','TV Licence','Water','Road Fund','Internet','Gas & Electricity','Building & Contents Insurance','Amazon Prime','BT Sport','Ring','Netflix','Firelighters and Wood']
    amount_by_month_bills_5_adj['Adj_Amount'] = [1980.36,92.75,161.64,0,145.76,493.41,489.39,98.75,175,49.98,0,0]
...
#   print(cars_1)
    ...
    selected = option_menu(
        menu_title = None,
        options=["Overview","Add Data","Modify Data","Cars","Mortgage Calculator","Training Plan"],
