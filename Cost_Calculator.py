    ...
    if selected == "Add Data":
        ...
        with col_3:
            if fn_Category == "House Bills":
                ...
                if fn_Category == "Cars":
                    fn_Item = st.selectbox("Item",['Mazda CX-5 - Insurance','Mazda CX-5 - Payments','Mazda CX-5 - Recovery','Mazda CX-5 - Servicing and Fixes','Mazda CX-5 - Tax','Peugeot 308 - Insurance','Peugeot 308 - Payments','Peugeot 308 - Recovery','Peugeot 308 - Servicing and Fixes','Peugeot 308 - Tax'], key = "Item")
                else:
