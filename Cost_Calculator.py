...
if authentication_status:
    ...
    amount_by_month_bills_5_adj['Item'] = ['Council Tax','TV Licence','Water','Road Fund','Internet','Gas & Electricity','Building & Contents Insurance','Amazon Prime','BT Sport']
    amount_by_month_bills_5_adj['Adj_Amount'] = [1980.36,92.75,161.64,0,145.76,493.41,489.39,98.75,175]
    ...
    if selected == "Overview":
        ...
        with left_column:
            ...
            st.subheader(f"£10,160.60")
        with right_column:
            st.text("Savings:")
            st.subheader(f"£35,000")
        with mid_column:
            st.text("Capital in Mortgages:")
            st.subheader(f"£473,000")
        with last:
